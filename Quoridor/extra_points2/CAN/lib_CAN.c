...
void CAN_setup (uint32_t ctrl)  {
  ...
  pCAN->IER   = 1;                               /* Enable all interrupts */
...
//  CAN_setup (2);                                  /* setup CAN Controller #2 */
  ...
  CAN_wrFilter (1, 1, STANDARD_FORMAT);          /* Enable reception on CAN 1 of messages from CAN 1 - TBV */
	CAN_wrFilter (1, 2, STANDARD_FORMAT); 				 /* Enable reception on CAN 1 of messages from CAN 1 - TBV */
